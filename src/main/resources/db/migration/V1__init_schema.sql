-- Phase 1 baseline migration (MySQL): workflow definition table.
-- CREATE DATABASE / USE are intentionally omitted: Flyway connects to the configured
-- schema (application.yml datasource URL already targets the /flowagent database).
-- Idempotent via IF NOT EXISTS; mirrors db/schema.sql `flow` table.
